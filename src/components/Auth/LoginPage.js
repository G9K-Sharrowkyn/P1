    ...
    return (
        <div className="flex items-center justify-center h-screen bg-gray-900 text-white">
            <form onSubmit={handleSubmit} className="bg-gray-800 p-6 rounded space-y-4">
                ...
                <button type="submit" className="bg-blue-500 hover:bg-blue-700 rounded px-4 py-2 w-full">Login</button>
                <Link to="/register" className="text-blue-400 block text-center">Need an account?</Link>
            </form>
        </div>
    );
};
